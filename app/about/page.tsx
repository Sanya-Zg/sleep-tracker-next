  ...
  return (
    <div className="font-sans bg-gray-100 text-gray-800">
      ...
      <section className="flex flex-col items-center justify-center text-center py-16 px-8 bg-gray-100">
        <h1 className="text-4xl md:text-5xl font-bold mb-4 bg-gradient-to-l from-orange-400 to-orange-800 bg-clip-text text-transparent">
          About SleepTracker
        </h1>
        <p className="text-lg md:text-xl bg-gradient-to-l from-orange-400 to-orange-800 bg-clip-text text-transparent">
      ...
      <section className="py-16 px-8 bg-gray-100 text-center">
        <h2 className="text-3xl font-bold mb-4 bg-gradient-to-l from-orange-400 to-orange-800 bg-clip-text text-transparent">
          Ready to Sleep Better?
        </h2>
        <p className="text-lg mb-6 bg-gradient-to-l from-orange-400 to-orange-800 bg-clip-text text-transparent">
